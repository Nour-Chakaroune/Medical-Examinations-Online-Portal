                      ...
                      <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group date reservationdate" data-target-input="nearest">
                                    <input type="text" class="form-control datetimepicker-input form" value="{{ date( 'd/m/Y',  strtotime($task->date)) }}" placeholder="Date" name="date" data-target=".reservationdate"/>
