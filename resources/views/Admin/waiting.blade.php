...
<!-- Content Header (Page header) -->
    <div class="content-header">
      <div class="container">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Waiting Medical Examination</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
                                    ...
                                    <div class="modal-body">
                                      ...
                                      <label>Prescribed Medical Tests:</label>
                                        ...
                                        <div class="form-group" align="center">
                                           <img src="{{ "data:image/" .$task->imageType. ";base64," .base64_encode( $task->image ) }}" class="img-fluid" style="width: 70%;"  alt="Try Again"/>
                                        </div>
                                    </div>
